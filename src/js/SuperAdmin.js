...
$(document).ready(function(){
    ...
    landcontract.methods.addSuperAdmin('0x1d01891b4326Ed72005A5feb4DC764d4185a41b6','Miraj');
    landcontract.methods.computeId('Maharashtra','Sangli','Miraj',15).call().then(function(id){
        console.log(id);
        landcontract.methods.Registration('Maharashtra','Sangli','Miraj',15,'0x1d01891b4326Ed72005A5feb4DC764d4185a41b6',500,id).call().then(function(k){
            from :'0x1d01891b4326Ed72005A5feb4DC764d4185a41b6';
            console.log('registered')
        });
        landcontract.methods.landInfoUser(id).call().then(function(k){
            from : '0x1d01891b4326Ed72005A5feb4DC764d4185a41b6';    
            console.log(k[0]);
        });
    })
